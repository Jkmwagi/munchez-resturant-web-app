...
<body>
		...
		<div id="header">
			<div id="img">
				...
				<div class="btn-group">
					...
					<button type="button" class="btn btn-danger" onclick="document.location.href = 'login.html'">Login</button>
				</div>
			</div>
        </div>
	</div>
	...
	<div id="footerwrap">
		<div id="footer">
			<br><br>
			<font size="3" color="white"><center> muchez cuisines.<a href="https://www.facebook.com/muchezcuisines"> <span class="social social-facebook"><img src="icon.png" width="40px" height="40px" align="center-right"/></span></a>
			<a href="https://twitter.com/muchezcuisines"> <span class="social social-twitter"><img src="icon_t.png" width="40px"  height="40px" align="center-right"/></span></a>
