...
<html>
<head>
<title>munchez-My Profile!</title>
	...
	<div id="headwrap">
		<div id="header">
			<div id="img">
              ...
              <button type="button" class="btn btn-danger" onclick="document.location.href = 'login.php'">Login</button>
            </div>
		</div>
...
<font size="3" color="white"><center>munchez <a href="https://www.facebook.com/Munchezcuisines"> <span class="social social-facebook"><img src="icon.png" width="40px" height="40px" align="center-right"/></span></a>
<a href="https://twitter.com/Munchezcuisines"> <span class="social social-twitter"><img src="icon_t.png" width="40px"  height="40px" align="center-right"/></span></a>
<
		</div>
	</div>
</body>
